...
export declare class World {
    ...
    footpoints: any[];
    msec: number;
    car_racing_game: boolean;
    temple_run_game: boolean;
    coin_collected: number;
    chair_broken: number;
    ckpts: any[];
    ckpt_seq: number;
    blender_collisions: any[];
    private lastScenarioID;
    constructor(worldScenePath?: any);
    init_trimesh_collision(world: World, path: string): void;
    car_racing(world: World): void;
    temple_run(world: World): void;
    private init_shadow;
